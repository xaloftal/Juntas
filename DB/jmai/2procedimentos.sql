...
create or replace procedure submeter_pedido(_dat date, _nom varchar(60), _nus int, _nif int, _tel1 int, _tel2 int, _cnum varchar(12), _cval date, _datnasc date, _freg_n varchar(60), _cod int, _rua varchar(60), _ut int, _freg_r varchar(60), _conc_r varchar(60), _conc_n varchar(60), out id_pedido int)
as $$
declare _ped int;
begin
